...
pub(crate) fn run_ui_smoke_test<P: IsA<gtk::Application>>(application: &P) -> anyhow::Result<()> {
    ...
    crate::ui_test_support::capture(&window, "downloads-empty", 800, 640)?;
    crate::ui_test_support::capture(&window, "downloads-empty-narrow", 360, 640)?;
    ...
    manager.show();
    crate::ui_test_support::capture(&window, "downloads", 800, 760)?;
    crate::ui_test_support::capture(&window, "downloads-narrow", 360, 640)?;
    adw::StyleManager::default().set_color_scheme(adw::ColorScheme::ForceDark);
    crate::ui_test_support::capture(&window, "downloads-dark", 800, 760)?;
