...
fn present_editor(parent: &AlcoveWindow, policy: AppPolicyV2, config: AppConfigV3) -> adw::Dialog {
    ...
    let navigation_error = crate::ui::dialogs::common::inline_error();
    ...
    let proxy_error = crate::ui::dialogs::common::inline_error();
    ...
    let background_error = crate::ui::dialogs::common::inline_error();
    ...
    let filter_error = crate::ui::dialogs::common::inline_error();
                    ...
                    async move {
                        ...
                        match result {
                            ...
                            Err(error) if !is_cancelled(&error) => {
                                crate::ui::dialogs::common::show_inline_error(
                                    &editor.filter_error,
                                    &error.to_string(),
                                )
                            }
