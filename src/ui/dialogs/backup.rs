...
pub(super) fn backup_options() -> (
    crate::ui::common::ActionDialog,
    adw::SwitchRow,
    adw::PasswordEntryRow,
    adw::PasswordEntryRow,
) {
    let options_dialog =
        crate::ui::common::ActionDialog::new(&gettext("Back Up Alcove"), &gettext("Back Up"));
    ...
    let mismatch = crate::ui::common::inline_error();
...
pub fn start_restore(parent: &AlcoveWindow) {
    ...
    glib::spawn_future_local(async move {
        ...
        let plan = loop {
            ...
            let progress = crate::ui::common::show_progress(&window, &gettext("Opening Backup…"));
...
pub(super) fn restore_passphrase_dialog(
    error: Option<&str>,
    ...
    let feedback = crate::ui::common::inline_error();
...
pub(super) fn restore_options(
    entries: &[crate::system::archive::RestorePreviewEntry],
    description: &str,
) -> (crate::ui::common::ActionDialog, RestoreSelection) {
    let action_dialog =
        crate::ui::common::ActionDialog::new(&gettext("Restore Applications"), &gettext("Restore"));
    let page = adw::PreferencesPage::new();
    let group = adw::PreferencesGroup::builder()
...
async fn show_restore_preview(parent: &AlcoveWindow, plan: RestorePlan) {
    ...
    let progress = crate::ui::common::show_progress(parent, &gettext("Restoring Applications…"));
