...
impl DownloadItem {
    pub(super) fn new(source_uri: String, suggested_name: &str) -> Rc<Self> {
    ...
    pub(super) fn set_downloading(&self, destination: String) {
...
pub struct DownloadManager {
    ...
    pub(super) items: RefCell<Vec<Rc<DownloadItem>>>,
    pub(super) dialog: RefCell<Option<adw::Dialog>>,
