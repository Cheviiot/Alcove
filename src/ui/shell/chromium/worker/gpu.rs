...
pub fn receive(socket: &UnixDatagram) -> Result<Option<Texture>> {
    ...
    let frame: Frame = serde_json::from_slice(&bytes[..received.bytes])?;
        ...
        frame.protocol == crate::engines::chromium::protocol::VERSION,
        ...
        (1..=crate::engines::chromium::protocol::MAX_DIMENSION).contains(&frame.width)
            && (1..=crate::engines::chromium::protocol::MAX_DIMENSION).contains(&frame.height),
