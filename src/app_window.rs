...
use crate::{
    ...
    service::AppService,
    util,
    web_app_shell::{adjusted_zoom_level, WebAppShell, DEFAULT_ZOOM_LEVEL, ZOOM_STEP},
};
...
impl AppWindow {
    ...
    fn setup_gactions(&self) {
        self.add_action_entries([
            gio::ActionEntry::builder("shortcuts")
                .activate(|window: &Self, _, _| crate::dialogs::show_shortcuts(window, true))
                .build(),
    ...
    fn shell(&self) -> &std::rc::Rc<WebAppShell> {
