...
mod protocol;
mod site_requests;
use crate::web_app_shell::{adjusted_zoom_level, WebAppShell, DEFAULT_ZOOM_LEVEL, ZOOM_STEP};
...
struct Options {
    ...
    app_id: Option<crate::model::AppId>,
...
impl Options {
    fn parse() -> Result<Self> {
        ...
        let result = Self {
            ...
            policy: policy::Policy::new(crate::policy::AppPolicyV2::default(), None),
...
pub struct Launch {
    ...
    pub policy: crate::policy::AppPolicyV2,
