...
use crate::{
    domain::model::{decode_app_config, AppConfigV3, AppId, Engine},
    domain::policy::{decode_policy, AppPolicyV2, MAX_POLICY_SERIALIZED_SIZE},
    domain::repository::{ProfileLock, RUNTIME_LOCK_FILE},
    system::launcher::{LauncherBackend, PortalLauncher},
...
mod tests {
    ...
    use super::*;
    use crate::{domain::repository::AppRepository, system::launcher::UninstallOutcome};
  ...
  "sort_order": 0
        ...
        assert_eq!(
            archived.config.schema_version,
            crate::domain::model::SCHEMA_VERSION
        );
