    ...
    fn setup_gactions(&self) {
        ...
        self.add_action_entries([
            gio::ActionEntry::builder("shortcuts")
                .activate(|window: &Self, _, _| crate::dialogs::show_shortcuts(window, false))
                .build(),
...
pub(crate) fn run_ui_smoke_test<P: IsA<gtk::Application>>(
    ...
    third.engine = crate::model::Engine::Chromium;
    window
        .imp()
        .engine_availability
    ...
    crate::ui_test_support::capture(&window, "library", 800, 640)?;
    crate::ui_test_support::capture(&window, "library-narrow", 360, 640)?;
    window.imp().search_bar.set_search_mode(true);
    ...
    crate::ui_test_support::capture(&window, "library-search", 360, 640)?;
    ...
    crate::ui_test_support::capture(&window, "library-no-results", 360, 640)?;
    window.close_search();
    ensure!(
    ...
    crate::ui_test_support::capture(&window, "library-dark", 800, 640)?;
    ...
    crate::ui_test_support::capture(&window, "library-large-end", 800, 640)?;
    ...
    crate::ui_test_support::capture(&window, "application", 800, 760)?;
    crate::ui_test_support::capture(&window, "application-narrow", 360, 640)?;
    page.expand_advanced();
    crate::ui_test_support::capture(&window, "application-edit", 800, 760)?;
    window.set_default_size(360, 640);
    crate::ui_test_support::settle();
    page.expand_advanced();
    crate::ui_test_support::capture(&window, "application-edit-narrow", 360, 640)?;
    crate::dialogs::show_shortcuts(&window, false);
    crate::ui_test_support::capture(&window, "shortcuts-narrow", 360, 640)?;
    if let Some(dialog) = window.visible_dialog() {
        dialog.force_close();
    }
    window.destroy();
...
pub(crate) fn render_settings<P: IsA<gtk::Application>>(application: &P) -> anyhow::Result<()> {
    ...
    crate::ui_test_support::capture(&window, "application-narrow", 360, 640)?;
    adw::StyleManager::default().set_color_scheme(adw::ColorScheme::ForceDark);
    crate::ui_test_support::capture(&window, "application-dark", 800, 760)?;
    adw::StyleManager::default().set_color_scheme(adw::ColorScheme::ForceLight);
    page.expand_advanced();
    crate::ui_test_support::capture(&window, "application-edit", 800, 760)?;
    window.set_default_size(360, 640);
...
pub(crate) fn render_utilities<P: IsA<gtk::Application>>(application: &P) -> anyhow::Result<()> {
    ...
    let capture = |name: &str| -> anyhow::Result<()> {
        ...
        crate::ui_test_support::capture(&window, name, 800, 760)?;
        crate::ui_test_support::capture(&window, &format!("{name}-narrow"), 360, 640)?;
        adw::StyleManager::default().set_color_scheme(adw::ColorScheme::ForceDark);
        crate::ui_test_support::capture(&window, &format!("{name}-dark"), 800, 760)?;
        adw::StyleManager::default().set_color_scheme(adw::ColorScheme::ForceLight);
    ...
    for (name, availability) in [
        ...
        (
            "installed",
            EngineAvailability::Available(crate::chromium::ChromiumCapabilities {
    ...
    crate::dialogs::show_shortcuts(&window, true);
