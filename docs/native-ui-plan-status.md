...
| Genuine libadwaita shell | Shared WebKit/CEF component in `src/web_app_shell.rs`; native opaque overlay header, Back/Forward/title/menu/window controls; 1.5 s hiding and F10; viewport preservation verified |
